...
for trials =1:1
    ...
    layers = [
        ...
        convolution2dLayer(2,9,'Padding','same')
        batchNormalizationLayer
        reluLayer

        maxPooling2dLayer(1,'Stride',2)

        convolution2dLayer(2,81,'Padding','same')
        batchNormalizationLayer
        reluLayer

        maxPooling2dLayer(1,'Stride',2)

        convolution2dLayer(2,243,'Padding','same')
        batchNormalizationLayer
        reluLayer
...
% save results
save (sprintf('%s_result3.mat',Current),'Acc_Val','Acc_Trn');